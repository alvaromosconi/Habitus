...
{
    private readonly UserManager<HabitusUser> userManager;
    private readonly RoleManager<IdentityRole> roleManager;
    private readonly IConfiguration _configuration;
    public AuthService(UserManager<HabitusUser> userManager, RoleManager<IdentityRole> roleManager, IConfiguration configuration)
    {
    ...
    public async Task<(int, string)> Registration(Registration model, string role)
    {
        ...
        HabitusUser user = new HabitusUser()
        {
            Email = model.Email,
